...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaG93aWV3b3JrIiwiYSI6ImNrdGoxeDVpODE3aHIydW1wZHF5ODJyMGoifQ.11L7FeMU0LwqfepiXh2A4g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/howiework/cktj5j2cn402717uiffxiya3l',
    scrollZoom: false // center: [-118.319569, 34.079207],
    // zoom: 10,
    // interactive: false,
...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "/Users/howie/Documents/04-tutorial/04-NodeJS/Jonas-NodeJS/complete-node-bootcamp-with-jonas/4-natours",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            // Pass TRUE to location.reload() is to make sure that load from server instead of browser cached files
...
var stripe = Stripe('pk_test_51Jb3ZWLviCuzdAbwSCQlbS6HKKO6037H8PE0vrgzihyBNl4MDgMMl2VWCy4j3KxrW8DoqbEvwHr1r4W49odLbe14001bxvRAdd');
